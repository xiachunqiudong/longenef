<template>
  <div>
    <span style="font-size: 30px;">Welcome to Longevity And Cancer Online Analysis Database</span>
    ...
    <el-row>
      ...
      <el-col span="10">
        <el-carousel height="400px">
          <el-carousel-item v-for="img in imgs" :key="img" style="text-align: center">
            <el-image
              style="width: 400px;"
              :src="img">
            </el-image>
